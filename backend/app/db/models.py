...
class CandidateStock(Base):
    ...
    sector_score: Mapped[int] = mapped_column(Integer, nullable=False)
    nine_turn_signal: Mapped[str] = mapped_column(String(10), nullable=False, default="")
    nine_turn_count: Mapped[int] = mapped_column(Integer, nullable=False, default=0)
    nine_turn_score: Mapped[int] = mapped_column(Integer, nullable=False, default=0)
